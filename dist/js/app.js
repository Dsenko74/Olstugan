 ...
 */
    ...
    (() => {
        ...
        function menuInit() {
            const menuText = document.querySelector(".header__mn");
            if (document.querySelector(".icon-menu")) {
                document.addEventListener("click", (function(e) {
                    if (bodyLockStatus && e.target.closest(".header__wrrt")) {
                        bodyLockToggle();
                        document.documentElement.classList.toggle("menu-open");
                        menuText.textContent = document.documentElement.classList.contains("menu-open") ? "Close" : "Menu";
                    }
                }));
                menuText.textContent = document.documentElement.classList.contains("menu-open") ? "Close" : "Menu";
            }
        ...
        function initSliders() {
            ...
            if (document.querySelector(".carte__slider")) new swiper_core_Swiper(".carte__slider", {
                modules: [ Navigation, Pagination, Autoplay ],
                observer: true,
                observeParents: true,
                slidesPerView: "auto",
        ...
        null && getDefaultExportFromCjs(fastDeepEqual);
        var LoaderStatus;
        ...
        const cityData = {
            Göteborg: {
                coordinates: {
                    lat: 57.71921336256073,
                    lng: 11.928407077968197
                },
                bars: [ {
                    bar: "Ölstugan_Tullen_Johanneberg",
                    lat: 57.72921336256073,
                    lng: 11.928407077968197,
                    image: "img/lunch/1.jpg",
                    location: "Friggagatan 27, 416 64 Göteborg, Sweden",
                    phone: "+46 76 313 05 96",
                    calendar: "15:00 – 00:00"
                }, {
                    bar: "Ölstugan_Tullen_Andra_Lång",
                    lat: 57.73821336256073,
                    lng: 11.938407077968197,
                    image: "img/lunch/2.jpg",
                    location: "Herkulesgatan 3A, 417 01 Göteborg, Sweden",
                    phone: "+46 31 16 56 16",
                    calendar: "16:00 – 01:00"
                }, {
                    bar: "Ölstugan_Tullen_Majorna",
                    lat: 57.74621336256073,
                    lng: 11.928407077968197,
                    image: "img/lunch/3.jpg",
                    location: "Ölstugan Tullen Gamlestaden",
                    phone: "+46 76 313 85 96",
                    calendar: "17:00 – 01:00"
                }, {
                    bar: "Ölstugan_Tullen_Lejonet",
                    lat: 57.71521336256073,
                    lng: 11.918407077968197,
                    image: "img/lunch/1.jpg",
                    location: "Friggagatan 27, 416 64 Göteborg, Sweden",
                    phone: "+46 76 313 05 96",
                    calendar: "15:00 – 00:00"
                }, {
                    bar: "Ölstugan_Tullen_Kville",
                    lat: 57.71421336256073,
                    lng: 11.928407077968197,
                    image: "img/lunch/2.jpg",
                    location: "Ölstugan Tullen Gamlestaden",
                    phone: "+46 76 313 85 96",
            ...
            Stockholm: {
                coordinates: {
                    lat: 59.32456559685972,
                    lng: 18.058270146732614
                },
                bars: [ {
                    bar: "Stockholm_Tullen_Johanneberg",
                    lat: 59.32866559685971,
                    lng: 18.058270146732614,
                    image: "img/lunch/1.jpg",
                    location: "Friggagatan 27, 416 64 Stockholm, Sweden",
                    phone: "+46 76 313 05 96",
                    calendar: "15:00 – 00:00"
                }, {
                    bar: "Stockholm_Tullen_Andra_Lång",
                    lat: 59.32766559685971,
                    lng: 18.02270146732614,
                    image: "img/lunch/2.jpg",
                    location: "Herkulesgatan 3A, 417 01 Stockholm, Sweden",
                    phone: "+46 31 16 56 16",
                    calendar: "16:00 – 01:00"
                }, {
                    bar: "Stockholm_Tullen_Majorna",
                    lat: 59.36666559685971,
                    lng: 18.058270146732614,
                    image: "img/lunch/3.jpg",
                    location: "Ölstugan Tullen Gamlestaden",
                    phone: "+46 76 313 85 96",
                    ...
                    bar: "Stockholm_Tullen_Lejonet",
                    lat: 59.39566559685971,
                    lng: 18.078270146732613,
                    image: "img/lunch/1.jpg",
                    location: "Friggagatan 27, 416 64 Stockholm, Sweden",
                    phone: "+46 76 313 05 96",
                    calendar: "15:00 – 00:00"
                }, {
                    bar: "Stockholm_Tullen_Kville",
                    lat: 59.31466559685971,
                    lng: 18.078270146732613,
                    image: "img/lunch/2.jpg",
                    location: "Ölstugan Tullen Gamlestaden",
                    phone: "+46 76 313 85 96",
            ...
            Norrköping: {
                coordinates: {
                    lat: 58.59504694714969,
                    lng: 16.18459565436626
                },
                bars: [ {
                    bar: "Norrköping_Tullen_Johanneberg",
                    lat: 58.59504694714969,
                    lng: 16.18459565436626,
                    image: "img/lunch/1.jpg",
                    location: "Friggagatan 27, 416 64 Norrköping, Sweden",
                    phone: "+46 76 313 48 96",
                    calendar: "15:00 – 00:00"
                }, {
                    bar: "Norrköping_Tullen_Andra_Lång",
                    lat: 58.60504694714969,
                    lng: 16.18459565436626,
                    image: "img/lunch/2.jpg",
                    location: "Herkulesgatan 3A, 417 01 Norrköping, Sweden",
                    phone: "+46 98 16 56 36",
                    calendar: "16:00 – 01:00"
                } ]
            }
        };
        const handleCityClick = city => {
            ...
            } else barsContainer.innerHTML = `<p> </p>`;
        };
        const toggleMarkerAndHighlight = (markerView, property) => {
            ...
            if (currentPub === property) currentPub = null; else currentPub = property;
        };
        (g => {
        ...
        async function initMap() {
            ...
            const map = new Map(document.getElementById("map"), {
                center: {
                    lat: cityData[city].coordinates.lat,
                    lng: cityData[city].coordinates.lng
                },
                zoom: 12,
        ...
        document.querySelector(".pubs__location").addEventListener("click", (function(e) {
            if (e.target.closest(".select__option")) {
                ...
                document.getElementById("bars-container");
                initMap();
                handleCityClick(city);
            }
        }));
        ...
        const buildInsta = item => {
            ...
            item.image ? instaItemTemplate += `<div class="item--instagram__image">\n      <img src="${item.image}" alt="pub">\n    </div>\n    ` : null;
        ...
        document.addEventListener("DOMContentLoaded", (function() {
            ...
            function updatePlaceholder() {
                ...
                } else placeholderAfter.style.visibility = "hidden";
            }
